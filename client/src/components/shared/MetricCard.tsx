...
export default function MetricCard({ label, value, icon, accentColor, themeColor, style }: MetricCardProps) {
  return (
    ...
    >
      ...
      <div style={{ padding: '1.75rem 1.5rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '1rem' }}>
        <div style={{ minWidth: 0 }}>
          <div style={{ fontSize: '0.6875rem', color: '#94A3B8', textTransform: 'uppercase', letterSpacing: '0.06em', fontWeight: 600 }}>
            {label}
          </div>
          <div style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: '2rem', fontWeight: 800, color: '#1B2A4A', lineHeight: 1.1, marginTop: '0.5rem' }}>
            {value}
          </div>
        </div>
        <div
